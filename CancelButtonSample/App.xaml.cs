...
using CancelButtonSample.Views;
...
namespace CancelButtonSample
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "CancelButtonSample.ViewModels.{0}ViewModel, CancelButtonSample", viewType.Name.Substring(0, viewType.Name.Length - 4));
